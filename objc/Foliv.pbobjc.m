  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "requestId",
        .dataTypeSpecific.clazz = Nil,
        .number = Foliv_FieldNumber_RequestId,
        .hasIndex = 12,
        .offset = (uint32_t)offsetof(Foliv__storage_, requestId),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldTextFormatNameCustom | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeBytes,
      },
      {
      ...
      },
      {
        .name = "userAgent",
        .dataTypeSpecific.clazz = Nil,
        .number = Foliv_FieldNumber_UserAgent,
        .hasIndex = 14,
        .offset = (uint32_t)offsetof(Foliv__storage_, userAgent),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldTextFormatNameCustom | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
      {
      ...
      },
      {
        .name = "appId",
        .dataTypeSpecific.clazz = Nil,
        .number = Foliv_FieldNumber_AppId,
        .hasIndex = 16,
        .offset = (uint32_t)offsetof(Foliv__storage_, appId),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldTextFormatNameCustom | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeUInt32,
      },
      {
        .name = "peerId",
        .dataTypeSpecific.clazz = Nil,
        .number = Foliv_FieldNumber_PeerId,
        .hasIndex = 17,
        .offset = (uint32_t)offsetof(Foliv__storage_, peerId),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldTextFormatNameCustom | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeUInt32,
      },
      {
        .name = "version",
        .dataTypeSpecific.clazz = Nil,
        .number = Foliv_FieldNumber_Version,
        .hasIndex = 18,
        .offset = (uint32_t)offsetof(Foliv__storage_, version),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeUInt32,
      },
      {
        .name = "roundtripTime",
        .dataTypeSpecific.clazz = Nil,
        .number = Foliv_FieldNumber_RoundtripTime,
        .hasIndex = 19,
