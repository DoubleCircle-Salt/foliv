...
pub struct Foliv {
    ...
    pub peerID: u32,
    pub version: u32,
    pub roundtripTime: i32,
    pub bindIPs: ::protobuf::RepeatedField<::std::vec::Vec<u8>>,
    // special fields
...
impl Foliv {
    ...
    pub fn take_userAgent(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.userAgent, ::std::string::String::new())
    }

    // uint32 requestHop = 16;


    pub fn get_requestHop(&self) -> u32 {
        self.requestHop
    }
    pub fn clear_requestHop(&mut self) {
        self.requestHop = 0;
    }

    // Param is passed by value, moved
    pub fn set_requestHop(&mut self, v: u32) {
        self.requestHop = v;
    }
    ...
    pub fn get_roundtripTime(&self) -> i32 {
        self.roundtripTime
    }
    ...
    // Param is passed by value, moved
    pub fn set_roundtripTime(&mut self, v: i32) {
    ...
    pub fn get_bindIPs(&self) -> &[::std::vec::Vec<u8>] {
        &self.bindIPs
    }
    pub fn clear_bindIPs(&mut self) {
        self.bindIPs.clear();
    }

    // Param is passed by value, moved
    pub fn set_bindIPs(&mut self, v: ::protobuf::RepeatedField<::std::vec::Vec<u8>>) {
        self.bindIPs = v;
    }

    // Mutable pointer to the field.
    pub fn mut_bindIPs(&mut self) -> &mut ::protobuf::RepeatedField<::std::vec::Vec<u8>> {
        &mut self.bindIPs
    }

    // Take field
    pub fn take_bindIPs(&mut self) -> ::protobuf::RepeatedField<::std::vec::Vec<u8>> {
        ::std::mem::replace(&mut self.bindIPs, ::protobuf::RepeatedField::new())
    }
}
...
impl ::protobuf::Message for Foliv {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                15 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.userAgent)?;
                },
                16 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                21 => {
                    ::protobuf::rt::read_repeated_bytes_into(wire_type, is, &mut self.bindIPs)?;
                },
                _ => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.userAgent.is_empty() {
            my_size += ::protobuf::rt::string_size(15, &self.userAgent);
        }
        if self.requestHop != 0 {
            my_size += ::protobuf::rt::value_size(16, self.requestHop, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.appID != 0 {
            my_size += ::protobuf::rt::value_size(17, self.appID, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.peerID != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.userAgent.is_empty() {
            os.write_string(15, &self.userAgent)?;
        }
        if self.requestHop != 0 {
            os.write_uint32(16, self.requestHop)?;
        }
        if self.appID != 0 {
            os.write_uint32(17, self.appID)?;
        }
        if self.peerID != 0 {
        ...
        if self.roundtripTime != 0 {
            os.write_int32(20, self.roundtripTime)?;
        }
        for v in &self.bindIPs {
            os.write_bytes(21, &v)?;
        };
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "userAgent",
                |m: &Foliv| { &m.userAgent },
                |m: &mut Foliv| { &mut m.userAgent },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "requestHop",
                |m: &Foliv| { &m.requestHop },
                |m: &mut Foliv| { &mut m.requestHop },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "appID",
                |m: &Foliv| { &m.appID },
                |m: &mut Foliv| { &mut m.appID },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "peerID",
                |m: &Foliv| { &m.peerID },
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0bfoliv.proto\x12\x05foliv\"\x8b\x05\n\x05Foliv\x12\x1a\n\x08userHas\
    ...
    (\x05R\rroundtripTime\x12\x18\n\x07bindIPs\x18\x15\x20\x03(\x0cR\x07bind\
    IPs*9\n\x07Command\x12\t\n\x05Empty\x10\0\x12\x0b\n\x07Connect\x10\x01\
    \x12\r\n\tAssociate\x10\x03\x12\x07\n\x03Mux\x10\x7f*B\n\x0bAddressType\
    \x12\x0f\n\x0bInvalidType\x10\0\x12\x08\n\x04IPv4\x10\x01\x12\x0e\n\nDom\
    ainName\x10\x03\x12\x08\n\x04IPv6\x10\x04B\tZ\x07./folivJ\x9f$\n\x06\x12\
    \x04(\0Q\x01\n\xc6\x17\n\x01\x0c\x12\x03(\0\x122\xbb\x17\x20?O$$O??77O7>\
    :!!7$O$O>>7?O$?CC7>7C$$QO77!!>7777>>>!!!>!!!!!!>7>>>>>>>>>>>>>>\n\x20?O$\
    OO??>?O7>:!>7$Q$OQOO?OO?CC?77O$Q$C77777?????77777>>>>>>>>>>>>>>>>>>>>>>>\
    \n\x20?$$OO?7>?C>OQ$$OHHQC?$$QHHNHHO>?$$QO77>>7?????????7>>>!!!!!>>>>>>>\
    >>>>>>>>>\n\x20C$$OC?7>O$?!O$N$$QQNCCCC7?QN$Q?OOCOC>7!77??CCCC?C??7>>>>>\
