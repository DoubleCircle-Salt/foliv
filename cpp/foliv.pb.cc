...
constexpr Foliv::Foliv(
  ...
  , routerpath_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , command_(0)
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_foliv_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::foliv::Foliv, routerlevel_),
  PROTOBUF_FIELD_OFFSET(::foliv::Foliv, useragent_),
  PROTOBUF_FIELD_OFFSET(::foliv::Foliv, requesthop_),
  PROTOBUF_FIELD_OFFSET(::foliv::Foliv, appid_),
  PROTOBUF_FIELD_OFFSET(::foliv::Foliv, peerid_),
  PROTOBUF_FIELD_OFFSET(::foliv::Foliv, version_),
  PROTOBUF_FIELD_OFFSET(::foliv::Foliv, roundtriptime_),
  PROTOBUF_FIELD_OFFSET(::foliv::Foliv, bindips_),
  PROTOBUF_FIELD_OFFSET(::foliv::Foliv, routerpath_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_foliv_2eproto = {
  false, false, 620, descriptor_table_protodef_foliv_2eproto, "foliv.proto", 
...
Foliv::Foliv(const Foliv& from)
  ...
  routerpath_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_routerpath().empty()) {
    routerpath_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_routerpath(), 
      GetArena());
  }
  ::memcpy(&command_, &from.command_,
    static_cast<size_t>(reinterpret_cast<char*>(&roundtriptime_) -
    reinterpret_cast<char*>(&command_)) + sizeof(roundtriptime_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&roundtriptime_) -
    reinterpret_cast<char*>(&command_)) + sizeof(roundtriptime_));
}
...
void Foliv::SharedDtor() {
  ...
  routerpath_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
// @@protoc_insertion_point(message_clear_start:foliv.Foliv)
  ...
  ::memset(&command_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&roundtriptime_) -
      reinterpret_cast<char*>(&command_)) + sizeof(roundtriptime_));
    ...
    switch (tag >> 3) {
      ...
      case 14:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 112)) {
          routerlevel_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // string userAgent = 15;
      case 15:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 122)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "foliv.Foliv.userAgent"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 16:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 128)) {
          requesthop_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // uint32 appID = 17;
      ...
      case 18:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 144)) {
          peerid_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // uint32 version = 19;
      ...
      case 21:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 170)) {
          ...
          do {
            ptr += 2;
            auto str = _internal_add_bindips();
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
      ...
      case 22:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 178)) {
          auto str = _internal_mutable_routerpath();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "foliv.Foliv.routerPath"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* Foliv::_InternalSerialize(
  ...
  if (this->routerlevel() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(14, this->_internal_routerlevel(), target);
  }
  ...
  if (this->useragent().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "foliv.Foliv.userAgent");
    target = stream->WriteStringMaybeAliased(
        15, this->_internal_useragent(), target);
  }

  // uint32 requestHop = 16;
  if (this->requesthop() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(16, this->_internal_requesthop(), target);
  }
  ...
  if (this->peerid() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(18, this->_internal_peerid(), target);
  }
  ...
  // repeated bytes bindIPs = 21;
  for (int i = 0, n = this->_internal_bindips_size(); i < n; i++) {
    const auto& s = this->_internal_bindips(i);
    target = stream->WriteBytes(21, s, target);
  }

  // string routerPath = 22;
  if (this->routerpath().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_routerpath().data(), static_cast<int>(this->_internal_routerpath().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "foliv.Foliv.routerPath");
    target = stream->WriteStringMaybeAliased(
        22, this->_internal_routerpath(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:foliv.Foliv)
  ...
  // repeated bytes bindIPs = 21;
  total_size += 2 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(bindips_.size());
  for (int i = 0, n = bindips_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::BytesSize(
      bindips_.Get(i));
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:foliv.Foliv)
  ...
  bindips_.MergeFrom(from.bindips_);
  ...
  if (from.routerpath().size() > 0) {
    _internal_set_routerpath(from._internal_routerpath());
  }
  if (from.command() != 0) {
  ...
  if (from.routerlevel() != 0) {
    _internal_set_routerlevel(from._internal_routerlevel());
  }
  if (from.requesthop() != 0) {
    _internal_set_requesthop(from._internal_requesthop());
  }
  if (from.appid() != 0) {
  ...
  if (from.roundtriptime() != 0) {
    _internal_set_roundtriptime(from._internal_roundtriptime());
  }
}
...
void Foliv::InternalSwap(Foliv* other) {
  ...
  bindips_.InternalSwap(&other->bindips_);
  ...
  routerpath_.Swap(&other->routerpath_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Foliv, roundtriptime_)
      + sizeof(Foliv::roundtriptime_)
